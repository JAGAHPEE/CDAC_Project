  ...
  else 
  {
    if (value_2 > THRESHOLD) 
    {
      ...
      else
      {
        ...
        display.println(F("I need Help"));
        DEBUG_LN("I need Help");
      }
    } 
    else
    {
      if (value_3 > THRESHOLD) 
      {
        ...
        display.println(F("Water Request"));
      ...
      else 
      {
        ...
        display.println(F("Plese Give Correct Command"));
        DEBUG_LN("Please Give correct Command");
      }
    }
  }
